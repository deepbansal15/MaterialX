...
#ifndef MATERIALX_HLSSYNTAX_H
#define MATERIALX_HLSSYNTAX_H
...
/// Syntax class for HLSL (High-Level Shading Language)
class MX_GENHLSL_API HlslSyntax : public Syntax
{
  public:
    HlslSyntax(TypeSystemPtr typeSystem);

    static SyntaxPtr create(TypeSystemPtr typeSystem) { return std::make_shared<HlslSyntax>(typeSystem); }
...
/// Specialization of TypeSyntax for aggregate types in HLSL
class MX_GENHLSL_API HlslStructTypeSyntax : public StructTypeSyntax
{
  public:
